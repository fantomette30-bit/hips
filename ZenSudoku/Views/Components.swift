...
/// Jauge de difficulté : neuf barres croissantes, remplies jusqu'au rang du niveau.
        ...
        HStack(alignment: .bottom, spacing: 1.6) {
            ForEach(1...9, id: \.self) { index in
                RoundedRectangle(cornerRadius: 0.9, style: .continuous)
                    ...
                    .frame(width: 1.9, height: 5 + CGFloat(index - 1) * 1.75)
            }
        }
        .accessibilityLabel("Difficulté \(rank) sur 9")
    }
}
